      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            project scope, and event subscriptions. You can provide a signing secret or let the API generate one;
            the resulting secret is shown once.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="webhook-custom-secret">Signing secret (optional)</Label>
            <Input
            ...
            />
            <p className="text-xs text-muted-foreground">
              If set, this value is used as the webhook signing secret. If blank, HyreLog generates a random
              secret for you.
            </p>
          </div>
          <Button
